...
-(void)addMonster{
    ...
    CCSprite* monster=[CCSprite   spriteWithFile:@"guaiguai.png"];
...
-(id) init
{
    if( (self=[super init])) {
        ...
        CCSprite* bj=[CCSprite  spriteWithFile:@"jingjing.jpg"];
        bj.position=ccp(screenSize.width*0.5, screenSize.height*0.5);
        
        CCSprite *bj2=[CCSprite spriteWithFile:@"cccv.jpg"];
        ...
        //飞机位置
        _f=[CCSprite  spriteWithFile:@"vfrtg.png"];
...
- (void)shoot2 {
    ...
    ccColor3B smokeo1 = ccc3(0,255,255);
    ...
    ccColor3B smokeo2 = ccc3(0,255,255);
...
- (void)shoot {
    ...
    CCSprite  *smoke=[CCSprite  spriteWithFile:@"dandan.png"];
