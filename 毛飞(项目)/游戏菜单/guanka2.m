...
-(id) init
{
	if( (self=[super init])) {
        ...
        CCSprite* bj=[CCSprite  spriteWithFile:@"ggggb.jpg"];
        bj.position=ccp(screenSize.width*0.5, screenSize.height*0.5);
        CCSprite *bj2=[CCSprite spriteWithFile:@"nhm.jpg"];
...
- (void)shoot2 {
    ...
    ccColor3B smokeo1 = ccc3(200,0,255);
    ...
    for(CCSprite *smoke in smokes){
        ...
        for(CCSprite *monster in monsterToDelete){
            ...
            if(monstersDestroyed>30){
                ...
                [[NSUserDefaults standardUserDefaults] setObject:@"guanka2" forKey:@"fh"];
