...
-(id)init{
    if( (self=[super init])) {
       ...
       id action6 = [CCBlink actionWithDuration:1.5 blinks:5];
        ...
        CCLabelTTF*label=[CCLabelTTF labelWithString:@"李刚 " dimensions:CGSizeMake(40, 50) alignment:NSTextAlignmentLeft fontName:@"Marker Felt" fontSize:20];
        ...
        CCLabelTTF*label2=[CCLabelTTF labelWithString:@"团长 " dimensions:CGSizeMake(40, 80) alignment:NSTextAlignmentLeft fontName:@"Marker Felt" fontSize:20];
        ...
        CCMenuItem* a1=[CCMenuItemFont   itemFromString:@":110112119" target:self selector:nil];
        a1.position=ccp(195, 380);
        [self  addChild:a1];
        
        [CCMenuItemFont  setFontName:@"Marker Felt"];
        [CCMenuItemFont  setFontSize:25];
        CCMenuItem* a01=[CCMenuItemFont   itemFromString:@"他的战机" target:self selector:nil];
