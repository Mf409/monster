...
-(id)init{
    if( (self=[super init])) {
       ...
       // 色调变化到 – CCTintTo
        id action6=[CCTintTo actionWithDuration:2 red:160 green:250 blue:120 ];
        ...
        CCLabelTTF*label=[CCLabelTTF labelWithString:@"张丰 " dimensions:CGSizeMake(40, 50) alignment:NSTextAlignmentLeft fontName:@"Marker Felt" fontSize:20];
        ...
        CCLabelTTF*label2=[CCLabelTTF labelWithString:@"旅长 " dimensions:CGSizeMake(40, 80) alignment:NSTextAlignmentLeft fontName:@"Marker Felt" fontSize:20];
        ...
        CCMenuItem* a1=[CCMenuItemFont   itemFromString:@":235469852" target:self selector:nil];
        ...
        //id action60 = [CCBlink actionWithDuration:1.5 blinks:5];
